        ...
        <div class="col-md-10 mb-3">
            <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                    ...
                    @endif
                    <form method="POST" action="{{ route('be.saveImageCollections') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                          <label for="title" class="form-label">Title</label>
                          <input type="text" name="title" class="form-control" id="title" aria-describedby="nameHelp">
                          <div id="name" class="form-text">The Title of the image collection.</div>
                        </div>
                        <div class="mb-3">
                            <label for="description" class="form-label">Description</label>
                            <input type="text" name="description" class="form-control" id="description" aria-describedby="nameHelp">
                            <div id="description" class="form-text">Descrtiption of the image collection.</div>
                        </div>
                        <div class="mb-3">
