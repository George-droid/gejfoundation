                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="news-item d-flex flex-column bg-white border rounded overflow-hidden h-100">
                            <div class="p-4">
                                <h6 class="text-primary mb-3">From Punch News</h6>
                                ...
                                <a href="#" class="btn btn-outline-primary read-more">Read More <i class="fa fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="news-item d-flex flex-column bg-white border rounded overflow-hidden h-100">
                            <div class="p-4">
                                <h6 class="text-primary mb-3">From Vanguard News</h6>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="news-item d-flex flex-column bg-white border rounded overflow-hidden h-100">
                            <div class="p-4">
                                <h6 class="text-primary mb-3">From Daily Trust</h6>
