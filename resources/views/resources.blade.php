...
<body>
    <div class="container py-5">
        <div class="text-center mb-5">
            <h1 class="display-6 section-title">Resources</h1>
            <p class="lead">Explore our collection of valuable resources.</p>
        </div>
        <ul class="resource-list">
            <li>
                ...
                <a href="resource-link1.pdf" class="btn btn-primary">Download</a>
            </li>
            <li>
