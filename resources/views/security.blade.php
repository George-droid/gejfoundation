                ...
                <div class="row g-4 justify-content-center">
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="position-relative overflow-hidden h-100" style="min-height: 400px;">
                            <img class="position-absolute w-100 h-100 pe-5" src="{{asset('img/banner4.webp')}}" alt="" style="object-fit: cover;">
                        </div>
                    </div>
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class=" mt-2">
                            ...
                            <p class="fs-5 mb-5"> We focus on conflict prevention, mediation, peacebuilding, and security sector reform. We work to build safe, stable communities through initiatives like disarmament, demobilization, and the reintegration of combatants.</p>
