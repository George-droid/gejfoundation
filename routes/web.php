...
Route::get('/team', [CustomAuthController::class, 'about'])->name('team');
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('/dashboard/get-images/{collection_id}', [GalleryController::class, 'getImages'])->name('be.getImages');
